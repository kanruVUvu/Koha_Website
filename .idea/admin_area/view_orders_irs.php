...
if(!isset($_SESSION['admin_email'])){
    ...
    $get_orders = "select * from customer_custom_orders where p_id = 10001";
...
//        $uploaded_image = $row_orders['uploaded_image'];
//
//        $bg_1 = $row_orders['bg_1'];
//
//        $bg_2 = $row_orders['bg_2'];
//
//        $bg_3 = $row_orders['bg_3'];
//
//        $bg_4 = $row_orders['bg_4'];
//
//        $bg_5 = $row_orders['bg_5'];
//
//        $bg_6 = $row_orders['bg_6'];
//
//        $color_code = $row_orders['color_code'];
//
//        $csv = $row_orders['csv'];
//
//        $lego = $row_orders['lego'];
//
//        $lego_gap = $row_orders['lego_gap'];
//
//        $output_images = $row_orders['output_images'];
        ...
        $get_orders = "select * from pending_orders where product_id = 10001 ";
        ...
        while ($row_orders = mysqli_fetch_array($run_orders)) {
            ...
            <td><img style="height: 50px; width: 50px" src="<?php
                ...
                while($row_products = mysqli_fetch_array($run_products)) {
                    $get_customer_order3 = "select * from customer_custom_orders where order_id='$order_id' and p_id = 10001";
...
//        echo $due_amount;
            ...
            <td>&#X20B9;
                <?php
                $get_customer_order2 = "select * from customer_orders where order_id='$order_id' and p_id = '$product_id'";
...
//            print_r("bY = ". $bY);
            ...
            $get_customer_order3 = "select * from customer_custom_orders where order_id='$order_id' and p_id = '$product_id' and customer_id = '$c_id'";
