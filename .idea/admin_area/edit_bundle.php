...
<input type="text" name="product_vb" class="form-control" required value="<?php echo $pro_vb; ?>">
...
<input type="text" name="product_hb" class="form-control" required value="<?php echo $pro_hb; ?>">
