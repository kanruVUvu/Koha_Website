...
<!--                    %-->
                    <img src="../admin_area/other_images/p-code.png" style="height: 30px; width: 40px" alt="">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse"><!-- collapse navbar-collapse navbar-ex1-collapse Starts -->
            ...
            <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav Starts -->
                ...
                <li><!-- manufacturer li Starts -->
                    ...
                    <a href="#" data-toggle="collapse" data-target="#view_orders"><!-- anchor Starts -->
                    ...
                    <ul id="view_orders" class="collapse"><!-- ul collapse Starts -->

                        <li>
                            <a href="index.php?view_orders"> Website Orders </a>
                        </li>

                        <li>
                            <a href="index.php?view_orders_irs"> IRS Custom Orders </a>
                        </li>
...
<!--                    <li>-->
<!---->
<!--                        <a href="index.php?view_orders_irs">-->
<!---->
<!--                            <i class="fa fa-fw fa-list"></i> View Orders IRS-->
<!---->
<!--                        </a>-->
<!---->
<!--                    </li>-->
