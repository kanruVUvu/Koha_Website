...
$pro_vb = $row_edit['v_size'];
$pro_hb = $row_edit['h_size'];
...
<input type="text" name="product_vb2" class="form-control" required value="<?php echo $pro_vb; ?>">
...
<input type="text" name="product_hb2" class="form-control" required value="<?php echo $pro_hb; ?>">
...
$product_vb2 = $_POST['product_vb2'];
$product_hb2 = $_POST['product_hb2'];
