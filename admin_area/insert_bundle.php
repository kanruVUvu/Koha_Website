...
<i class="fa fa-money fa-fw"></i> Insert Bundles
...
<label class="col-md-3 control-label" > Vertical Baseplates Used for Medium Size</label>

<div class="col-md-6" >

<input type="text" name="product_vb" class="form-control" required >
...
<label class="col-md-3 control-label" > Horizontal Baseplates Used for Medium Size</label>

<div class="col-md-6" >

<input type="text" name="product_hb" class="form-control" required >
...
$product_vb = $_POST['product_vb'];
$product_hb = $_POST['product_hb'];
...
$insert_product = "insert into products (p_cat_id,product_type,cat_id,manufacturer_id,v_size,h_size,product_title,product_url,product_img1,product_img2,product_img3,product_price,product_psp_price,product_desc,product_features,product_video,product_keywords,product_label,status) values ('$product_cat','$p_type','$cat','$manufacturer_id','$product_vb','$product_hb','$product_title','$product_url','$product_img1','$product_img2','$product_img3','$product_price','$psp_price','$product_desc','$product_features','$product_video','$product_keywords','$product_label','$status')";
