...
<input type="text" name="c_email" class="form-control" required value="<?php echo $customer_email; ?>" disabled>
...
$update_customer = "update customers set customer_name='$c_name',customer_lname='$c_lname',customer_email='$c_email',customer_country='$c_country',customer_city='$c_city',customer_contact='$c_contact',customer_address='$c_address',customer_state='$c_state',customer_pincode='$c_pincode' where customer_id='$update_id'";
...
?>
<script>document.title = "Koha Website Edit Account";</script>
