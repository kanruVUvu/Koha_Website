  ...
  <main id="main">
      <div class="sec-2">
          <section style="background-color: black; color: white">
              <div class="container">
                  <div style="display: flex; justify-content: left;position:relative;top:10px;" data-aos="fade-up" data-aos-duration="30000">
                      <h2 style="text-align:right; font-size: 20px !important;"><a style="color: #ddb253; text-decoration: none" href="index.php">Home&nbsp;</a>
                      </h2>
                      <h2 style="color: white !important; font-size: 20px !important;"> / Confirm Order</h2>
                      <!--<ol>
