...
def render(image_filename=None, imgpath=None, baseplate_size=(2, 2), num_of_colors=20, user_colors=[], autoselect='on',
    ...
    # if num_base > 14:
    #     bgs = ['bg6.png', 'bg7.png', ]
    #     bg_vals = [[50, 40, 310, 190, 0x000, 0x444444, -2, 1], [130, 100, 735, 365, '#82695C', 0x444444, 2, -1]]
    # elif num_base > 8:
    #     bgs = ['bg3.png', 'bg4.png', 'bg5.png']
    #     bg_vals = [[70, 50, 500, 170, 0x000, 0x444444, -2, 1], [70, 50, 365, 135, '#82695C', 0x444444, 2, -1],
    #                [55, 50, 410, 115, '#82695C', 0x444444, 2, -1]]
    # else:
    #     bgs = ['bg1.jpg', 'bg2.jpg','bg3.jpg', 'bg4.jpg', 'bg5.jpg','bg6.jpg', 'bg7.jpg']
    #     bg_vals = [[100, 120, 430, 280, 0x000, 0x444444, -2, 1], [90, 120, 370, 260, '#82695C', 0x444444, 2, -1]]

    bgs = ['bg1.png', 'bg2.png', 'bg3.png', 'bg4.png', 'bg5.png', 'bg6.png']

    # if (baseplate_size[0] == 2 and baseplate_size[1] == 2) or (baseplate_size[0] == 3 and baseplate_size[1] == 3):
    if baseplate_size[0] == 2 and baseplate_size[1] == 2:
        bg_vals = [[120, 110, 460, 235, 0x000, 0x444444, -2, 1], [80, 60, 396, 244, '#82695C', 0x444444, 2, -1],
                   [100, 70, 500, 170, '#82695C', 0x444444, 2, -1], [110, 80, 365, 170, '#82695C', 0x444444, 2, -1],
                   [100, 80, 340, 170, '#82695C', 0x444444, 2, -1], [100, 80, 311, 165, '#82695C', 0x444444, 2, -1]]
    else:
        bg_vals = [[44, 33, 460, 235, 0x000, 0x444444, -2, 1], [45, 33, 396, 244, '#82695C', 0x444444, 2, -1],
                   [53, 35, 500, 170, '#82695C', 0x444444, 2, -1], [51, 37, 365, 170, '#82695C', 0x444444, 2, -1],
                   [50, 41, 340, 170, '#82695C', 0x444444, 2, -1], [50, 41, 311, 165, '#82695C', 0x444444, 2, -1]]
    ...
    for i in range(len(bgs)):
        ...
        # Reduce Image
        resized_img = brick_img.resize((baseplate_size[1] * bg_vals[i][0], baseplate_size[0] * bg_vals[i][1]))
        he = baseplate_size[0] * bg_vals[i][1]
        if he > 200:
            he = 190
        resized_img = brick_img.resize((baseplate_size[1] * bg_vals[i][0], he))
        ww, hh = img_bg.size
        w, h = resized_img.size
        x, y = bg_vals[i][2] - (w // 2), bg_vals[i][3] - (h // 2)
