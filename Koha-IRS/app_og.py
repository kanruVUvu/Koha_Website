...
def pixelizer():
    ...
    if request.method == "POST":
        ...
        if request.form.get('base_btn') == "" or request.form.get('btncol') == "" or request.form.get('btncol-mob') == "":
            ...
            return render_template('pixelizer.html', image_filename=imglb, imagepath=out_img_path, data=data, actualysize=actualysize, actualxsize=actualxsize, actualpieces=actualpieces, actualprice=actualprice, counttest=counttest, tokentest=tokentest)
